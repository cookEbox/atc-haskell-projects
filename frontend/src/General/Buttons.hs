...
textBox NotPassword setVauleEv Persistent
  = inputElement $ def
                 & inputElementConfig_setValue .~ setVauleEv
                 & inputElementConfig_elementConfig
                   . elementConfig_initialAttributes
                   .~ ("maxlength" =: "64")
textBox NotPassword setVauleEv (Hideable hideEv)
  = inputElement $ def
                 & inputElementConfig_setValue .~ setVauleEv
                 & inputElementConfig_elementConfig
                   . elementConfig_initialAttributes
